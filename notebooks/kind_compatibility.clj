...
(def kind-status
  [
   ...
   {:clojupyter :n, :description :kind/vega, :clay :c, :clerk :u, :kind :kind/vega}
   ...
   {:clojupyter :n, :description :kind/var, :clay :c, :clerk :u, :kind :kind/var}
   ...
   {:clojupyter :n, :description :kind/scittle, :clay :c, :clerk :u, :kind :kind/scittle}
